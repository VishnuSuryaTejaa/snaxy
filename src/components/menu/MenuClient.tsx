      ...
      <main className="w-full max-w-6xl px-4 sm:px-6 pb-24 flex flex-col gap-10">
        ...
        <div className="flex flex-col md:flex-row items-stretch md:items-center justify-between gap-4 glass p-4 sm:p-5 rounded-3xl border border-white/[0.08] shadow-xl">
          ...
          <div className="relative flex-1 max-w-md">
            ...
            <input
              ...
              className="w-full rounded-2xl border border-white/[0.08] bg-black/40 pl-11 pr-10 py-3 text-sm text-white placeholder:text-slate-400 focus:outline-none focus:border-primary/60 focus:ring-2 focus:ring-primary/20 transition-all font-medium"
            />
            {search && (
              <button
                onClick={() => setSearch('')}
        ...
        {filtered.length === 0 ? (
          <div className="flex flex-col items-center justify-center py-20 animate-fade-in glass rounded-3xl border border-white/[0.08] p-8 text-center my-6">
            ...
            <h2 className="text-2xl font-black tracking-tight mb-2 text-white font-heading">
            ...
            <button
              ...
              className="px-6 py-2.5 rounded-xl bg-primary text-white font-bold text-xs hover:bg-primary/90 transition shadow-lg active:scale-95"
            >
              Show Full Menu
            </button>
          </div>
