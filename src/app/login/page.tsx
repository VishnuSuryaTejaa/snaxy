...
export default function LoginPage() {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      if (data.success) {
        // Force a hard refresh to re-evaluate auth layout/nav state if needed
  ...
  return (
    <div className="min-h-screen flex items-center justify-center relative overflow-hidden bg-background">
      ...
      <div className="absolute bottom-1/4 right-1/4 w-96 h-96 bg-blue-500/10 rounded-full blur-[128px] mix-blend-screen pointer-events-none" />
      ...
      <div className="w-full max-w-md p-6 relative z-10">
        <div className="glass rounded-3xl p-8 shadow-2xl border border-white/10 backdrop-blur-xl animate-in fade-in zoom-in duration-500">
          <div className="text-center mb-8">
            ...
            <p className="text-muted-foreground">Sign in to your Snaxy account</p>
          </div>
